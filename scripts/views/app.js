define(['backbone', 'underscore', 'jquery', 'todomodel', 'text!templates/main.html'],
    ...
    var App = Backbone.View.extend({
        ...
        renderOne: function(model){
            ...
            {
                this.$('#list-todos').append("<li><input class='checked' id='"+ model.get("id") + "' type='checkbox' checked><label><h4 class='hello' id='"+ model.get("id") + "'>  " + model.get("title") + "</h4></label>     <a id='"+ model.get("id") + "' class='destroy'></a></input></li>");
            }
            else {
                this.$('#list-todos').append("<li><input class='checked' id='"+ model.get("id") + "' type='checkbox'><label><h4 class='hello' id='"+ model.get("id") + "' >  " + model.get("title") + "</h4></label>      <a id='"+ model.get("id") + "' class='destroy'></a></input></li>");
