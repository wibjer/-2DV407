define(['backbone', 'underscore', 'jquery', 'todomodel', 'text!templates/main.html'],
    ...
    var App = Backbone.View.extend({
        ...
        renderOne: function(model){
            ...
            {
                this.$('#list-todos').append("<li><input type="checkbox" name="checkboxG4" id='"+ model.get("id") + "' class="css-checkbox" checked><label for='"+ model.get("id") + "' class="css-label"><h4 class='hello' id='"+ model.get("id") + "'>  " + model.get("title") + "</h4></label><a id='"+ model.get("id") + "' class='destroy'>X</a></li>");
            }
            else {
                this.$('#list-todos').append("<li><input type="checkbox" name="checkboxG4" id='"+ model.get("id") + "' class="css-checkbox"><label for='"+ model.get("id") + "' class="css-label"><h4 class='hello' id='"+ model.get("id") + "'>  " + model.get("title") + "</h4></label><a id='"+ model.get("id") + "' class='destroy'>X</a></li>");
